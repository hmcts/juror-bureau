;(function(){
  ...
  validate.validators.postponeTo = function(_, options, key, attributes){
    ...
    if (typeof attributes[key] === 'undefined' || attributes[key] === '') {
      ...
      message.fields.push('Enter a new service start date to postpone to');
    ...
    if (!deferToDate.isValid()) {
      message.summary = 'Enter a new service start date in the correct format, for example, 31/01/2023';
      message.fields.push('Enter a new service start date in the correct format, for example, 31/01/2023');
    ...
    if (deferToDate.isSameOrBefore(originalDate)) {
      ...
      message.fields.push('New service start date cannot be earlier than the original summons start date');
    ...
    if (deferToDate.isAfter(originalDate.add(12, 'M'))) {
      ...
      message.fields.push('New service start date cannot be more than 12 months after the original summons start date');
