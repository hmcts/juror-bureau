...
const poolRequests = require('../../objects/pool-list').poolRequests;
const poolTypeSelectValidator = require('../../config/validation/pool-create-select');
...
module.exports.index = function (app) {
  return function (req, res) {
    let promiseArr = [];
    let status = req.query['status'] || 'requested';
...
function urlBuilder (app, params, options) {
  let paramsClone = _.clone(params);
