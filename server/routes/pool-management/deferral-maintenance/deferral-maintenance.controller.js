...
module.exports.getDeferrals = function (app) {
  return function (req, res) {
    ...
    const validatorResult = validate(req.body, validator.courtNameOrLocation());
    ...
    const courtCode = req.body.courtNameOrLocationCode.match(/\d+/g);
...
module.exports.getProcessCheckedDeferrals = function (app) {
  return function (req, res) {
    const processSuccessCB = function (data) {
...
module.exports.postProcessCheckedDeferrals = function (app) {
  return function (req, res) {
    ...
    const processSuccessCB = function () {
    ...
    const processErrorCB = function (err) {
      req.session.errors = {
        deferrals: [{
    ...
    const validatorResult = validate(req.body, validator.selectedActivePool());
    if (typeof validatorResult !== 'undefined') {
      req.session.errors = validatorResult;
