...
const searchPoolObj = require('../../../objects/pool-search.js').poolSearchObject;
const fetchCourts = require('../../../objects/request-pool').fetchCourts;
const searchValidator = require('../../../config/validation/pool-search');
const modUtils = require('../../../lib/mod-utils');
const validate = require('validate.js');
const isCourtUser = require('../../../components/auth/user-type.js').isCourtUser;
...
module.exports.index = function (app) {
  return function (req, res) {
    ...
    const poolSearchRequest = function () {
      // Run API request
      return searchPoolObj.post(
        ...
        .catch(function (err) {
          const redirectUrl = app.namedRoutes.build('pool-search.get');
...
module.exports.post = function (app) {
  return function (req, res) {
    let court = req.body.courtNameOrLocation;
    let courtLocation = req.body.courtNameOrLocation.match(/\d+/g);
    let validatorResult;
    let redirectUrl = app.namedRoutes.build('pool-search.get');
    let dateToUse;
    let parameters = [];
