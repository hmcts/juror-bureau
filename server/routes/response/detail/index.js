...
module.exports = function (app) {
  ...
  app.get('/response/:id/awaiting-information/:type(\paper)?',
    'response.detail.awaiting.information.get',
    auth.verify, controller.getAwaitingInformation(app),
  );
  app.post('/response/:id/awaiting-information/:type(\paper)?',
    'response.detail.awaiting.information.post',
    auth.verify, controller.postAwaitingInformation(app),
  );
  ...
  app.get('/response/:id/responded/:type(paper|digital)?',
    'response.detail.responded.get',
    auth.verify,
    controller.getResponded(app),
  );
  app.post('/response/:id/responded/:type(paper|digital)?',
    'response.detail.responded.post',
    auth.verify,
    controller.postResponded(app),
  );
  ...
  // Download PDF
  app.get('/response/:id/download-pdf',
    'response.detail.download-pdf.get',
    auth.verify,
    controller.getDownloadPDF(app),
  );

  // Bureau Status
  app.get('/response/:id/bureaustatus',
    'reponse.detail.bureaustatus.get',
    auth.verify,
    controller.getBureauStatus(app),
  );
  app.post('/response/:id/bureaustatus',
    'reponse.detail.bureaustatus.post',
    auth.verify,
    controller.postBureauStatus(app),
  );
