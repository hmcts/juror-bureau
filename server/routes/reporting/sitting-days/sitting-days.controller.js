(function() {
  ...
  module.exports.getAttendanceDates = function(app) {
    return function(req, res) {
      const reportType = reportKeys(app, req)['sitting-days'];
      ...
      return res.render('reporting/standard-reports/date-search', {
        ...
        tmpBody,
        reportKey: 'sitting-days',
        title: reportType.title,
        searchLabels: reportType.searchLabelMappers,
        reportUrl: app.namedRoutes.build(`reports.sitting-days.filter.dates.post`),
  ...
  module.exports.postAttendanceDates = function(app) {
    return function(req, res) {
      ...
      if (toDate.isBefore(fromDate)) {
        ...
        return res.redirect(app.namedRoutes.build('reports.sitting-days.filter.post')
