...
const jurorTransferValidator = require('../../../config/validation/juror-transfer');
const jurorBulkTransferValidator = require('../../../config/validation/juror-bulk-transfer');
