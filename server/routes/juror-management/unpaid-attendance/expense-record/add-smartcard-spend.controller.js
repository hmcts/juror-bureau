...
module.exports.getAddSmartcardSpend = function (app) {
  return function (req, res) {
    ...
    const postUrl =
      app.namedRoutes.build('juror-management.unpaid-attendance.expense-record.add-smartcard-spend.post', {
        jurorNumber,
        poolNumber,
      });
...
module.exports.postAddSmartcardSpend = function (app) {
  return async function (req, res) {
    ...
    if (validatorResult) {
      ...
      return res.redirect(
        app.namedRoutes.build('juror-management.unpaid-attendance.expense-record.add-smartcard-spend.get', {
          jurorNumber,
          poolNumber,
