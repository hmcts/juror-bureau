(function() {
  ...
  module.exports = function(app) {
    ...
    app.get('/juror-management/record/:jurorNumber/expenses/bank-details',
      'juror-record.bank-details.get',
      auth.verify,
      controller.getBankDetails(app));

    app.post('/juror-management/record/:jurorNumber/expenses/bank-details',
      'juror-record.bank-details.post',
      auth.verify,
      controller.postBankDetails(app));

    // EDITING NOTES ROUTES
    app.get('/juror-management/record/:jurorNumber/expenses/bank-details/notes/edit',
      'juror-record.bank-details.notes-edit.get',
      auth.verify,
      jurorRecordController.getEditNotes(app));

    app.post('/juror-management/record/:jurorNumber/expenses/bank-details/notes/edit',
      'juror-record.bank-details.notes-edit.post',
      auth.verify,
      jurorRecordController.postEditNotes(app));

    // EDITING ADDRESS ROUTES
    app.get('/juror-management/record/:jurorNumber/expenses/bank-details/address',
      'juror-record.bank-details.address.get',
      auth.verify,
      editJurorController.getEditDetails(app));

    app.get('/juror-management/record/:jurorNumber/expenses/bank-details/address/edit',
      'juror-record.bank-details.address-edit.get',
      auth.verify,
      editJurorController.getEditDetailsAddress(app));

    app.post('/juror-management/record/:jurorNumber/expenses/bank-details/address/edit',
