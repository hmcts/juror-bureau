...
(function() {
  ...
  module.exports = function(app) {
    app.get('/juror-management/expenses/:jurorNumber/:locCode/enter-expenses',
      'juror-management.enter-expenses.get',
      auth.verify,
      isCourtUser,
      controller.getEnterExpenses(app));

    app.post('/juror-management/expenses/:jurorNumber/:locCode/enter-expenses',
      'juror-management.enter-expenses.post',
      auth.verify,
      isCourtUser,
      controller.postEnterExpenses(app));

    app.post('/juror-management/expenses/:jurorNumber/:locCode/enter-expenses/apply-to-all',
      'juror-management.enter-expenses.apply-to-all.post',
      auth.verify,
      isCourtUser,
      controller.postApplyExpensesToAll(app));

    app.get('/juror-management/expenses/:jurorNumber/:locCode/enter-expenses/loss-over-limit',
      'juror-management.enter-expenses.loss-over-limit.get',
      auth.verify,
      isCourtUser,
      controller.getLossOverLimit(app));

    app.post('/juror-management/expenses/:jurorNumber/:locCode/enter-expenses/loss-over-limit',
      'juror-management.enter-expenses.loss-over-limit.post',
      auth.verify,
      isCourtUser,
      controller.postLossOverLimit(app));

    app.get('/juror-management/expenses/:jurorNumber/:locCode/enter-expenses/travel-over-limit',
      'juror-management.enter-expenses.travel-over-limit.get',
      auth.verify,
      isCourtUser,
      controller.getTravelOverLimit(app));

    app.get('/juror-management/expenses/:jurorNumber/:locCode/enter-expenses/total-less-zero',
    ...
    app.post('/juror-management/expenses/:jurorNumber/:locCode/enter-expenses/recalculate-totals',
