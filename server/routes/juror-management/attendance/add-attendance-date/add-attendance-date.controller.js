...
const { convertTimeToHHMM } = require('../../../../lib/mod-utils');
const attendanceDateValidator = require('../../../../config/validation/add-attendance');
const { jurorAddAttendanceDao } = require('../../../../objects/juror-attendance');

module.exports.getAddAttendanceDate = function (app) {
  return async function (req, res) {
    let tmpErrors = _.clone(req.session.errors);
    let tmpFields = _.clone(req.session.formFields);
    let { jurorNumber, poolNumber } = req.params;
