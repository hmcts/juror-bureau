...
const changeTimesValidator = require('../../../../config/validation/change-attendance-times').changeAttendanceTimes;
const { jurorAttendanceDao } = require('../../../../objects/juror-attendance');
const { convert12to24, convert24to12, timeArrayToString } = require('../../../../components/filters');
...
module.exports.postChangeTimes = function (app) {
  return async function (req, res) {
    ...
    const attendanceDate = _.clone(req.session.attendanceDate);
    let invalidUrl;
    let redirectUrl;
