...
const checkInOutTimeValidator = require('../../../../config/validation/check-in-out-time');
const { convertAmPmToLong, timeArrayToString, convert12to24 } = require('../../../../components/filters');
...
module.exports.getConfirmAttendance = function (app) {
  return async function (req, res) {
    let processUrl;
    let cancelUrl;
    let attendanceDate = req.session.attendanceListDate;
...
module.exports.getNotCheckedOut = function (app) {
  return function (req, res) {
    ...
    let attendanceDate = req.session.attendanceListDate;
    let jurorsNotCheckedOut = req.session.jurorsNotCheckedOut;
