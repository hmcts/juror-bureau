...
module.exports.getDisqualify = (app) => {
  return (req, res) => {
    ...
    let backLinkUrl = app.namedRoutes.build('process-reply.get', routeParameters);
    let processUrl = app.namedRoutes.build('process-disqualify.post', routeParameters);
    let cancelUrl;
    ...
    let tmpFields = req.session.formFields;
