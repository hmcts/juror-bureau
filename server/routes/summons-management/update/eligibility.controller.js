(function() {
  ...
  module.exports.get = (app) => async (req, res) => {
    ...
    const postUrl = app.namedRoutes.build('summons.update-eligibility.post', { id, type });
    const cancelUrl = app.namedRoutes.build('response.paper.details.get', { id, type: 'paper' }) + '#eligibility';
  ...
  module.exports.post = (app) => async (req, res) => {
    ...
    if (typeof validatorResult !== 'undefined') {
      ...
      return res.redirect(app.namedRoutes.build('summons.update-eligibility.get', { id, type: 'paper' }));
    }
    ...
    try {
      ...
      return res.redirect(app.namedRoutes.build('response.paper.details.get', { id, type: 'paper' }) + '#eligibility');
    } catch (err) {
