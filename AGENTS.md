...
- Trusted verification runs dependency installation, build, and ESLint for changed JavaScript files. Repository-wide lint has substantial pre-existing failures and unit-test automation is incomplete, so Jenkins and human review remain authoritative.
